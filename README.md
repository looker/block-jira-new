...
Great! Blocks were designed for continuous improvement through the help of the entire Looker community, and we'd love your input. To log an error or improvement recommendation, please reach out to Looker support to submit a request. Please be as detailed as possible in your explanation, and we'll address it as quick as we can.
